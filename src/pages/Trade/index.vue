<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li> <img :src="order.imgUrl" style="width:100px; height:100px" alt=""> </li>
          <li>
            <p>{{order.skuName}}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
            <h3>￥{{parseFloat(order.orderPrice).toFixed(2)}}</h3>
          </li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          ...
          <span>¥{{parseFloat(orderInfo.originalTotalAmount).toFixed(2)}}</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{parseFloat(orderInfo.totalAmount).toFixed(2)}}</span></div>
  ...
  export default {
    ...
    methods:{
      changeDefault(address){
        // 全部置为 0
        this.addressInfo.forEach(element => element.isDefault = '0');
        // 点击谁谁是1
        address.isDefault = '1'
      },
      // 提交订单
      async submitOrder(){
        ...
        let data = {
          consignee:consignee,    // 收件人名字
          consigneeTel:phoneNum,  // 收件人手机号码
          deliveryAddress:fullAddress,  // 收货地址
          paymentWay:'ONLINE',
          orderComment:this.msg,  // 卖家留言信息
